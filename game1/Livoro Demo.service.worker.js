...
/** @type {string} */
const CACHE_VERSION = '1759994553|1561601935';
/** @type {string} */
const CACHE_PREFIX = 'Livoro Demo-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Livoro Demo.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Livoro Demo.html","Livoro Demo.js","Livoro Demo.offline.html","Livoro Demo.icon.png","Livoro Demo.apple-touch-icon.png","Livoro Demo.audio.worklet.js","Livoro Demo.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Livoro Demo.wasm","Livoro Demo.pck"];
